        ...
        <div className="rounded-xl border border-border bg-card p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="font-display text-2xl font-bold text-foreground">
              Bem-vindo a  <span className="text-gradient-primary">Matchmaking</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="nomeCompleto" type="text" placeholder="João da Silva" value={nomeCompleto} onChange={e => setNomeCompleto(e.target.value)} className="pl-10 h-11 bg-input border-border focus:border-primary focus:ring-2 focus:ring-primary/20" disabled={isLoading} />
              </div>
              {validationErrors.nomeCompleto && <p className="text-sm text-destructive">
            ...
            <div className="space-y-2">
              ...
              {validationErrors.username && <p className="text-sm text-destructive">
                  {validationErrors.username}
                </p>}
              {!validationErrors.username && isAvailable === false && <p className="text-sm text-destructive">
                  Este username já está em uso
                </p>}
              {!validationErrors.username && isAvailable === true && <p className="text-sm text-primary">Username disponível!</p>}
            </div>

            {/* Submit Button */}
            <Button type="submit" className="w-full h-12 text-base font-semibold" disabled={isButtonDisabled}>
              {isLoading ? <>
