                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <NavLink
                        ...
                        className="flex items-center gap-3 px-3 py-2.5 rounded-md text-slate-300 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors text-[15px]"
