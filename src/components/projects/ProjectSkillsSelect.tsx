...
export function ProjectSkillsSelect({
  ...
  // Filter and group available skills
  const filteredSkills = useMemo(() => {
    ...
    return grouped;
  }, [availableSkills, selectedSkillIds, search]);
  ...
  return (
    <div className="space-y-2">
      <label className="text-sm font-medium text-foreground">Habilidades Usadas</label>
      ...
      <p className="text-xs text-muted-foreground">
        Selecione até {maxSkills} habilidades técnicas usadas neste projeto.
      </p>
    </div>
  );
}
