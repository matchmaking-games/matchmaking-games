...
const navItems = [
  { label: "Perfil", to: "/studio/manage/profile", value: "perfil" },
  { label: "Links", to: "/studio/manage/profile/links", value: "links" },
];

export function StudioProfileNavigation() {
  ...
  const getActiveTab = () => {
    if (currentPath === "/studio/manage/profile/links") return "links";
    return "perfil";
  };
